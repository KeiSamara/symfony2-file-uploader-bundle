...
class UploadHandler
{
    ...
    protected function trim_file_name($file_path, $name, $size, $type, $error,
        ...
        if (function_exists('exif_imagetype') && $size) {
        ...
        if ($this->options['image_library']) {
            if (extension_loaded('imagick')) {
                ...
                try {
                    ...
                    // TODO: why don't we just skip not image files?
                    // get_image_size called on each uploaded file...
    ...
    public function post($print_response = true) {
        // TODO: is this safe against csrf?
